$package('dreamcc.UserRole');
dreamcc.UserRole = function(){
	var _box = null;
	var _this = {
  			...
  			dataGrid:{
  				title:'SiteType List',
	   			...
	   			columns:[[
						...
						{field:'loginTime',title:'最后一次登陆时间',width:120,sortable:true},
						{field:'roleStr',title:'角色',width:150,sortable:true}
				]],
				toolbar:[
