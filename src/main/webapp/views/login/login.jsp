...
<body>
	...
	<div id="contPar" class="contPar">
		<div id="page1" style="z-index: 1;">
			...
			<div class="title1">阳光，微笑，未来的你，都是最美好的事情</div>
			<div class="imgGroug">
				<ul>
			...
			<img alt="" class="img3 png" src="./img/login/page1_3.jpg">
		</div>
	</div>
	<div class="tyg-div-denglv">
		...
		<form id="loginForm" action="toLogin" method="post">
				...
				<div style="margin: 5px 0px;">
					<input name="username" class="username easyui-validatebox" data-options="required:true,validType:'email',missingMessage:'邮箱不能为空.',invalidMessage:'邮箱格式不正确'" type="text" placeholder="请输入账号..." />
				</div>
				<div style="margin: 5px 0px;">
					<input name="password" class="password easyui-validatebox" data-options="required:true,missingMessage:'密码不能为空.'" type="password" placeholder="请输入密码..." />
				</div>
				<div style="margin: 5px 0px;">
					<input type="text" style="width: 150px;" placeholder="请输入验证码..." />
					<img src="./img/login/1.png" style="vertical-align: bottom;" alt="刷新 " />
				</div>
				<button type="submit">
