...
<script type="text/javascript" src="${webUrl}/js/sys/role.js"></script>
</head>
<body>
	<div class="warp easyui-panel" data-options="border:false">
		...
		<div class="easyui-panel ui-search-panel" title="Search box"
			...
			<form id="searchForm">
				<p class="ui-fields">
					<label class="ui-label">角色:</label> <input name="roleName"
		...
		<div id="edit-win" class="easyui-dialog" title="Edit"
			...
			<form id="editForm" class="ui-form" method="post">
				...
				<div class="ui-edit">
					...
					<div class="fitem">
						<label>角色:</label> <input class="easyui-validatebox"
