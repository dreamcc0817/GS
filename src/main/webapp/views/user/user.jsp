...
<script type="text/javascript" src="${webUrl}/js/sys/user.js"></script>
</head>
<body>
	<div class="warp easyui-panel" data-options="border:false">
		...
		<div class="easyui-panel ui-search-panel" title="Search box"
			...
			<form id="searchForm">
				<p class="ui-fields">
					<label class="ui-label">Email:</label><input name="email"
						class="easyui-box ui-text" style="width: 100px;"> <label
						class="ui-label">NickName: </label><input name="nickName"
		...
		<div id="edit-win" class="easyui-dialog" title="Edit"
			...
			<form id="editForm" class="ui-form" method="post">
				...
				<div class="ui-edit">
					...
					<div class="fitem">
						<label>Email:</label> <input class="easyui-validatebox"
							type="text" name="email"
							data-options="required:true,validType:'email'">
					</div>

					<div class="fitem">
						<label>NickName:</label> <input class="easyui-validatebox"
							type="text" name="nickName"
							data-options="required:true,validType:'length[1,10]'">
					</div>
					<div class="fitem">
						<label>State:</label> <select class="easyui-combobox" name="state"
		...
		<div id="edit-pwd-win" class="easyui-dialog" buttons="#editPwdbtn"
			...
			<form id="pwdForm" class="ui-form" method="post">
				...
				<div class="ui-edit">
					...
					<div class="fitem">
						<label>Old PassWord:</label> <input id="oldPwd" name="oldPwd"
							type="password" class="easyui-validatebox" />
					</div>
					<div class="fitem">
						<label>New PassWord:</label> <input id="newPwd" name="newPwd"
							type="password" class="easyui-validatebox"
							data-options="required:true" />
					</div>
					<div class="fitem">
						<label>Re PassWord:</label> <input id="rpwd" name="rpwd"
